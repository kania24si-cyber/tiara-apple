...
<html lang="en">
    ...
    <body>
        ...
        <section class="hero-section">
            <div class="container">
                <h1 class="font-custom">contoh font custom</h1>
                    ...
                    <div class="card mb-4">
                        <div class="card-body">
                            ...
                            <p class="card-text">Our application provides a clean and intuitive interface,
                                allowing users to navigate easily and perform tasks efficiently. Built with
                                Laravel and Bootstrap, it offers flexibility and responsiveness.</p>
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <p class="text-muted small mt-3 mb-0">
                                Gunakan
                                <code>.card</code>
                                untuk konten yang butuh border & sedikit efek shadow.
                            </p>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="card-body">
                            ...
                            <form action="{{ route('question.store') }}" method="POST">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" nama="email" value="{{old('email')}}">
                                </div>
                                <div class="mb-3">
                                ...
                                <table class="table align-middle">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>Editor</td>
                                            <td>
                                                <span class="badge text-bg-warning">Pending</span></td>
                                        </tr>
                                    </tbody>
                                </table>
                            </div>
                            <p class="text-muted small mb-0">Tambahkan
        ...
        <footer class="footer">
            <div class="container">
                <p>&copy;
                    {{date('Y')}}
                    My Laravel App. All Rights Reserved.</p>
            </div>
        </footer>
